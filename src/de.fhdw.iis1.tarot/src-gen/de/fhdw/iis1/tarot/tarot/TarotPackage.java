...
public interface TarotPackage extends EPackage
{
   ...
   * @ordered
   */
  int GEHE_ZU__ZIEL = ANWEISUNG_FEATURE_COUNT + 0;
  ...
  /**
   * Returns the meta object for the attribute '{@link de.fhdw.iis1.tarot.tarot.GeheZu#getZiel <em>Ziel</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the attribute '<em>Ziel</em>'.
   * @see de.fhdw.iis1.tarot.tarot.GeheZu#getZiel()
   * @see #getGeheZu()
   * @generated
   */
  EAttribute getGeheZu_Ziel();
  ...
  /**
   * Returns the meta object for the attribute '{@link de.fhdw.iis1.tarot.tarot.KonditionalerGeheZu#getZiel <em>Ziel</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the attribute '<em>Ziel</em>'.
   ...
   * @generated
   */
  EAttribute getKonditionalerGeheZu_Ziel();
  ...
  interface Literals
  {
     ...
     * @generated
     */
    EAttribute GEHE_ZU__ZIEL = eINSTANCE.getGeheZu_Ziel();
     ...
     * @generated
     */
    EAttribute KONDITIONALER_GEHE_ZU__ZIEL = eINSTANCE.getKonditionalerGeheZu_Ziel();
